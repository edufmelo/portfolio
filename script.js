$(document).ready(function () {
    ...
    const translations = {
        en: {
            ...
            welcome: "Welcome,",
            aboutMe: "My name is Eduardo Melo, I’m 22 and currently studying Computer Engineering, developing skills in both hardware and software. With a year of professional experience as a developer, I recently enriched my academic journey through an exchange program at NOVA FCT, and I remain focused on growing in the tech field.",
        ...
        pt: {
            ...
            welcome: "Bem-vindo,",
            aboutMe: "Meu nome é Eduardo Melo, tenho 22 anos e atualmente estou cursando Engenharia de Computação, desenvolvendo habilidades tanto em hardware quanto em software. Com um ano de experiência profissional como desenvolvedor, recentemente enriqueci minha trajetória acadêmica por meio de um intercâmbio na NOVA FCT e continuo focado em crescer na área de tecnologia.",
